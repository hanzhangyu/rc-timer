...
var Timer = function (_Component) {
  ...
  function Timer(props) {
    ...
    _this.startTimer = function () {
      _this.props.immediate ? _this.combineEventAsync() : _this.combineEvent();
    };

    _this.resetTimer = function (callback, resetState) {
      if (resetState) {
        // console.warn('this.props.timeout',this.props.timeout)
        _this.setState({ leftTime: _this.props.timeout }, function () {
          _this.clearTimer();
          callback();
        });
        return;
      ...
      console.warn('this.state.leftTime', _this.state.leftTime);
      _this.clearTimer();
    };
...
Timer.propTypes = {
  ...
  running: _react.PropTypes.bool, // 是否继续运行
  async: _react.PropTypes.bool, // 忽略trigger函数是否执行完成
